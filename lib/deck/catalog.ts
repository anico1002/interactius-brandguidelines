...
export const LAYOUT_CATALOG: LayoutCatalogEntry[] = [
  ...
  { marker: 'contexto',    kind: 'contexto',      name: 'Contexto',        slots: 'antetítulo (CONTEXTO) + párrafo' },
  ...
  { marker: 'equipo',      kind: 'team',          name: 'Equipo',          slots: 'párrafos (**negrita**) + imagen (default de marca)' },
